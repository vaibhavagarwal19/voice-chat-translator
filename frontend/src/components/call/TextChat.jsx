...
export default function TextChat() {
  const { sendTextMessage, isConnected, currentRoom } = useSocket()
    ...
    <div>
      ...
      <div className="flex gap-2">
        <input
          ...
          disabled={disabled}
          className="flex-1 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-sm disabled:opacity-50 disabled:cursor-not-allowed"
        />
        <button
          onClick={handleSend}
